...
public class OSSClientConstants {
    ...
    public static final String ACCESS_KEY_ID = "LTAIVet1KWAptKOe";
    //阿里云API的密钥Access Key Secret
    public static final String ACCESS_KEY_SECRET = "MAWKrMtBwA9bYLL6f06dXMIxrHzk7S";
    //阿里云API的bucket名称 //wyc-img-data.oss-cn-beijing-internal.aliyuncs.com
    public static final String BACKET_NAME = "boboa0";
    //阿里云API的文件夹名称
